...
public class DealsStepWithMapDefinition {
	...
	public void user_already_on_login_page() {
		System.setProperty("webdriver.chrome.driver","C:\\Users\\yogeeswar\\Downloads\\Compressed\\chromedriver_win32\\chromedriver.exe");
	...
	public void user_enters_contacts_details(DataTable dealData) throws InterruptedException {
		...
		for (Map<String, String> data : dealData.asMaps(String.class, String.class)) {
			...
			driver.findElement(By.id("probability")).clear();
